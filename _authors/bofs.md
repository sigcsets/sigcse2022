...
In Pathable, each BoF will also have a persistent chat area and space for hosting files relevant to your BoF.  After seeing the success that the International Computing Education Research Conference (ICER) had using Discord for more in-depth discussions beyond the individual sessions, we hope that the week-long Zoom meeting room and additional chat functionality will work similarly for the Technical Symposium.
